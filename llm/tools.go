...
type FunctionCall struct {
	...
	// A non-nil empty list explicitly marks plaintext Codex collaboration
	// arguments. Nil means the upstream did not provide this signal.
...
type ResponseCustomToolCall struct {
	...
	Name string `json:"name"`
	// Namespace identifies the owning Responses tool namespace.
	Namespace string `json:"namespace,omitempty"`
