...
func newCloseOnceStream(stream streams.Stream[*httpclient.StreamEvent]) *closeOnceStream {
	return &closeOnceStream{Stream: stream}
}
...
func (reader *sseStreamReader) Stop(interrupt func() error) {
