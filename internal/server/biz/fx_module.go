...
var Module = fx.Module("biz",
	...
	fx.Provide(NewManagedRequestBodyWriter),
	fx.Provide(NewForwardingObservationWriter),
	fx.Provide(NewRequestServiceWithObservationWriter),
	...
	fx.Provide(NewQuotaServiceWithObservationWriter),
